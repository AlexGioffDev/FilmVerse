...
export const MoviePageComponent = ({ id }: { id: string | undefined }) => {
  ...
  return (
    ...
    >
      <div className="w-[370px] md:w-full max-w-[1000px] mx-auto h-[85vh]  p-2 md:p-8 space-y-5 z-[5] bg-primary/80 border border-stone-100 rounded-md  my-2 overflow-y-auto">
        <div className="flex flex-col md:flex-row md:gap-x-10 ">
          {/* Poster and info */}
          <div className="w-[300px] mx-auto  md:w-[450px] h-auto border border-slate-100 overflow-hidden rounded-lg">
            <img
        ...
        <div className="p-2 space-y-2 text-secondary">
